...
//     {/* ✅ Add donation count and verified status */}
  ...
  useEffect(() => {
    const checkDonorProfile = async () => {
      try {
        ...
        console.log(`Looking for donor profile for user ID: ${userData._id}`);
        const response = await fetch(`http://localhost:4000/donor/user/${userData._id}`);
