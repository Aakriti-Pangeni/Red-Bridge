...
//   // ✅ SAFE NAME EXTRACTION FUNCTION
//   const getUserDisplayName = () => {
//     if (!user) return "Guest";
    
//     // For admin users (they have 'name' property)
//     if (user.name) {
//       return user.name.split(" ")[0];
//     }
    
//     // For regular users (they have 'userName' property)
//     if (user.userName) {
...
//         {/* 🟡 Show center Welcome msg in mobile mode */}
//         {user && (
